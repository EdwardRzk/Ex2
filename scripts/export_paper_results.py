...
def export(root: Path, output: Path) -> None:
    ...
    output.mkdir(parents=True); metadata={"task":"frozen report recovery only","offline_evaluator_rerun_required":False,"compiler_gym_initialized":False,"llvm_execution":False,"objecttext_observation":False,"primary_reports_fully_recoverable":list(MAIN),"methods_with_complete_secondary_metrics":["PA-MambaNVP"],"methods_partial_metrics":{"NVP":"top1/top5 unavailable; final policy45 regret unavailable in aggregate","MLP":"top1/top5 unavailable; final policy45 regret unavailable in aggregate","LSTM":"top1/top5 unavailable; final policy45 regret unavailable in aggregate","Transformer":"top1/top5 unavailable; final policy45 regret unavailable in aggregate","Mamba":"top1/top5 unavailable; final policy45 regret unavailable in aggregate","Direct MambaNVP":"top1/top5 unavailable in formal reports","Anchored MambaNVP":"top5 unavailable in formal reports"},"optional_cross_candidate":{"status":"not exported to main canonical table","reason":"target main table is restricted to the eight requested methods"},"sources":sources,"records":records,"headline_values":headline}
